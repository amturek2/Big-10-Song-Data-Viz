...
export default function SongIdentitySection({ conferenceFilter = "All" }) {
  ...
  const heatmapExplainModal =
    showHeatmapExplain && typeof document !== "undefined"
      ? createPortal(
          <div
          ...
          >
            ...
            >
              ...
              <p className="identityModal_text identityModal_math">
                <strong>How we calculate the scores:</strong> for each fight
                song, we scan the lyrics and count how often certain kinds of
                words appear (for example, battle words like <i>fight</i>,{" "}
                <i>crush</i>, <i>conquer</i>). We then blend in a few musical
                details like tempo and song length to adjust some themes up or
                down (longer, slower songs tend to feel more traditional;
                faster songs tend to feel more aggressive). Those ingredients
                are combined into six theme scores for each song, and the
                heatmap shows the average of those scores for all schools in a
                conference.
              </p>

              <div className="identityModal_grid">
                <div className="identityModal_item">
                  <div className="identityModal_label">
                    Aggression / Conflict
                  </div>
                  <div className="identityModal_desc">
                    Battle language: fight, beat, crush, defeat, strike, smash,
                    battle, enemy, charge, attack, rush, war, wreck.
                  </div>
                </div>
                <div className="identityModal_item">
                  <div className="identityModal_label">Unity / Brotherhood</div>
                  <div className="identityModal_desc">
                    We, us, our, together, stand, united, one, team, loyal,
                    brothers, comrades, band, side, forever.
                  </div>
                </div>
                <div className="identityModal_item">
                  <div className="identityModal_label">Tradition / Legacy</div>
                  <div className="identityModal_desc">
                    Alma mater, honor, faithful, old, tradition, glory,
                    valiant, heritage, legend, legacy, hail.
                  </div>
                </div>
                <div className="identityModal_item">
                  <div className="identityModal_label">Cheer & Chant</div>
                  <div className="identityModal_desc">
                    Rah, hey, hail, hooray, cheer, yell, shout, clap, roar,
                    chant, sing, chorus, boom.
                  </div>
                </div>
                <div className="identityModal_item">
                  <div className="identityModal_label">School Pride</div>
                  <div className="identityModal_desc">
                    School name, mascot, campus, home, plus colors like blue,
                    scarlet, crimson, gold, navy, cardinal, maroon, silver,
                    white, black.
                  </div>
                </div>
                <div className="identityModal_item">
                  ...
                  <div className="identityModal_desc">
                    Champion, victory, triumph, win, titles, crown, best,
                    greatest, mighty, strong, leaders, conquering.
                  </div>
                </div>
              </div>
            </div>
